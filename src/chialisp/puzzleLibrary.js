...
exports.STANDARD_MOD_HASHES = exports.PUZZLE_TYPES = void 0;
exports.loadChialispPuzzle = loadChialispPuzzle;
exports.getModHash = getModHash;
exports.createChialispPuzzle = createChialispPuzzle;
exports.getStandardModHash = getStandardModHash;
...
function getLibPath() {
    ...
    const possiblePaths = [
        (0, path_1.join)(__dirname), // src/chialisp
        (0, path_1.join)(process.cwd(), 'src/chialisp'),
        (0, path_1.join)(__dirname, '../chialisp')
    ];
 ...
 */
function loadChialispPuzzle(puzzleType) {
    const filePath = exports.PUZZLE_TYPES[puzzleType];
    // Check cache first
    if (puzzleCache.has(filePath)) {
        return puzzleCache.get(filePath);
    }
    const libPath = getLibPath();
    const fullPath = (0, path_1.join)(libPath, filePath);
    ...
    // Calculate mod hash
    const modHash = (0, utils_1.calculateModHash)(ast);
    const puzzle = {
        name: puzzleType,
        source,
        ast,
 ...
 */
function getModHash(puzzleType) {
 ...
 */
function createChialispPuzzle(puzzleType) {
    const chialisppuzzle = loadChialispPuzzle(puzzleType);
    const builder = (0, PuzzleBuilder_1.puzzle)();
 ...
 */
function getStandardModHash(puzzleType) {
    // Return known hash if available
    if (puzzleType in exports.STANDARD_MOD_HASHES) {
        return exports.STANDARD_MOD_HASHES[puzzleType];
    }
